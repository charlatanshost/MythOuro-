...
echo "  4. RELEVANCE — does it stay on the question? (the bar that matters for use):"
echo "     bash run_instruct_probe.sh $(P $c)"
echo "     read the on-domain rate at alpha=0: code 15/15 and medical 7/15 on the trained 278M."
echo "     A model that is fluent but answers a different question is not usable; this is the"
echo "     number that says which."
echo
