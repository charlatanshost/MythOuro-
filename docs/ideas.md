...
| 2026-06-18 · Grow the model (more params via 8-bit Adam) | Fails #1 — token-starved (~170× undertrained); bigger model = hungrier, worse | Token-curve shows we've reached compute-optimal at current size |
